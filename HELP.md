...
* The original package name 'coderscampus.test-repo2' is invalid and this project uses 'coderscampus.testrepo2' instead.
...
* [Spring Data R2DBC](https://docs.spring.io/spring-boot/docs/2.7.6-SNAPSHOT/reference/htmlsingle/#data.sql.r2dbc)
